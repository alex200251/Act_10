...
{
    lis->ordenarId(); // Ordena la lista

    // Borra el contenido actual del QPlainTextEdit
    ui->plainTextEdit_2->clear();

    // Recorre la lista ordenada y muestra los elementos en plainTextEdit_2
    Neurona *aux = lis->h;
    while (aux) {
        ...
        // Agrega la información de la neurona a plainTextEdit_2
...
{
    lis->ordenarVoltaje(); // Ordena la lista por voltaje

    // Borra el contenido actual del QPlainTextEdit
    ui->plainTextEdit_2->clear();

    // Recorre la lista ordenada por voltaje y muestra los elementos en plainTextEdit_2
    Neurona *aux = lis->h;
    while (aux) {
        QString neuronaInfo = "Neurona: " + QString::number(aux->id) + "\n";
        neuronaInfo += "Voltaje: " + QString::number(aux->voltaje) + "\n";
